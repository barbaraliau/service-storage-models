...
PaymentProcessor.save('pre', function() {
  // validate method to make sure only one each of PaymentProcessor
})
...
// update paymentProcessor data --> .findAndUpdate(_id) replace rawData
      return UserModel
        .update({
