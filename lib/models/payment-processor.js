 ...
 * @return {Object}
 */
PaymentProcessor.methods._parseData = function(rawData) {
  if (!rawData) {
    return new errors.BadRequestError('Must pass in rawData');
  }
  return rawData[0];
}
 ...
 * @return {Array}
 */
PaymentProcessor.methods._serializeData = function(rawData) {
  if (!rawData) {
